...
public class Lottery{
    ...
    public Lottery(ArrayList<Job> joblist, double TIMESLICE){ 
    ...
    public static void main (String[] args) {
        ...
        jobArray.add(new Job(10, 0, false, 0)); 
        jobArray.add(new Job(8, 0, false, 0)); 
        jobArray.add(new Job(6, 0, false, 0)); 
        jobArray.add(new Job(4, 0, false, 0));
        jobArray.add(new Job(2, 0, false, 0));

        Lottery badname = new Lottery(jobArray, 2);
        badname.run();
    }
}